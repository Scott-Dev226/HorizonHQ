...
const useApiFetch = () => {
  ...
  useEffect(() => {
    ...
    fetch(fetchURL3)
      ...
      .then(function (data) {
        const stock1TodaysClose = data[inputRef2.current.value].values[0].close;
        ...
        const stock2TodaysClose = data[inputRef3.current.value].values[0].close;
        ...
        const stock3TodaysClose = data[inputRef4.current.value].values[0].close;
    ...
    fetch(histFetchURL3)
      ...
      .then(function (data) {
        ...
        let i;
        for (i = 100; i >= 0; i--) {
          stockCascadeClose.push(data[inputRef2.current.value].values[i].close);
