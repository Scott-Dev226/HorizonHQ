...
import appleBackground from '../aapl-back.jpg';
import microsoftBackground from '../msft-back.jpg';
import googleBackground from '../goog-back.jpg';
import fbBackground from '../fb-back.png';
...
useEffect(async () => {
    ...
    if (toggle == "Lansing") {
        ...
        const fetchURL2 = 'https://api.openweathermap.org/data/2.5/onecall?lat=' + lat + '&lon=' + long + '&exclude=hourly,minutely&appid=' + key + '&units=imperial'
...
<animated.div id = "weather-holder" style={{opacity:props.opacity, marginTop:props.marginTop}}>

<h1>NYSE DATA COMING SOON!</h1>
